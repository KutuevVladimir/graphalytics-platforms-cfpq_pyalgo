 ...
 */
public class CFPQ_PyAlgoLoader {

	private static final Logger LOG = LogManager.getLogger();

	protected CommandLine commandLine;
	protected FormattedGraph formattedGraph;
	protected CFPQ_PyAlgoConfiguration platformConfig;


	/**
	 *	Graph loader for CFPQ_PyAlgo.
	 * @param formattedGraph
	 * @param platformConfig
	 */
	public CFPQ_PyAlgoLoader(FormattedGraph formattedGraph, CFPQ_PyAlgoConfiguration platformConfig) {
