 ...
 */
public final class CFPQ_PyAlgoConfiguration {

	protected static final Logger LOG = LogManager.getLogger();

	private static final String BENCHMARK_PROPERTIES_FILE = "benchmark.properties";
	private static final String HOME_PATH_KEY = "platform.cfpq_pyalgo.home";
	private static final String NUM_MACHINES_KEY = "platform.cfpq_pyalgo.num-machines";
	private static final String NUM_THREADS_KEY = "platform.cfpq_pyalgo.num-threads";
	...
	/**
	 * Creates a new CFPQ_PyAlgoConfiguration object to capture all platform parameters that are not specific to any algorithm.
	 */
	public CFPQ_PyAlgoConfiguration(){
	}
	...
	public static CFPQ_PyAlgoConfiguration parsePropertiesFile() {

		CFPQ_PyAlgoConfiguration platformConfig = new CFPQ_PyAlgoConfiguration();
