 ...
 */
package science.atlarge.graphalytics.cfpq_pyalgo.algorithms.cdlp;
...
/**
 * Community Detection job implementation for CFPQ_PyAlgo. This class is responsible for formatting CDLP-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author Kutuev Vladimir
 */
public final class CommunityDetectionLPJob extends CFPQ_PyAlgoJob {
	 ...
	 */
	public CommunityDetectionLPJob(RunSpecification runSpecification, CFPQ_PyAlgoConfiguration platformConfig,
