 ...
 */
package science.atlarge.graphalytics.cfpq_pyalgo.algorithms.sssp;
...
/**
 * Single Source Shortest Paths job implementation for CFPQ_PyAlgo. This class is responsible for formatting SSSP-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author Kutuev Vladimir
 */
public final class SingleSourceShortestPathsJob extends CFPQ_PyAlgoJob {
	...
	public SingleSourceShortestPathsJob(RunSpecification runSpecification,
										CFPQ_PyAlgoConfiguration platformConfig,
