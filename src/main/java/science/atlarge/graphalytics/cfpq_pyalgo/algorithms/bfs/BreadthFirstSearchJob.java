...
/**
 * Breadth-first Search job implementation for CFPQ_PyAlgo. This class is responsible for formatting BFS-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author Kutuev Vladimir
 */
public final class BreadthFirstSearchJob extends CFPQ_PyAlgoJob {
	 ...
	 */
	public BreadthFirstSearchJob(RunSpecification runSpecification, CFPQ_PyAlgoConfiguration platformConfig,
